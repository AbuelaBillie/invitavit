window.addEventListener("load", function () {
    ...
    var imagenes = new Array(
      ["./img/galeriaNuriaMauro/1.webp"],
      ["./img/galeriaNuriaMauro/2.webp"],
      ["./img/galeriaNuriaMauro/3.webp"],
      ["./img/galeriaNuriaMauro/4.webp"],
      ["./img/galeriaNuriaMauro/5.webp"],
      ["./img/galeriaNuriaMauro/6.webp"],
      ["./img/galeriaNuriaMauro/7.webp"]
    );
    var contador = 0;
  ...
  countdown('Jul 27 2022 21:00:00 GMT-0300', 'reloj', '0 días restantes');
  ////////////////////////////////////////////////////
  });
